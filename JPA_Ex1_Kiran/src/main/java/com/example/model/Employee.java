...
public class Employee {
	...
	public String toString() {
		return "Employee [id=" + id + ", name=" + name + ", salary=" + salary + ", gender=" + gender + ", dob=" + dob
				+ ", joinDate=" + joinDate + ", profile=" + profile + ", pic=" + Arrays.toString(pic) + ", addresses="
				+ addresses + ", address=" + address + ", officeAddress=" + officeAddress + ", department=" + department
				+ "]";
	}
